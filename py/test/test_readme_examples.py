# VisitorStatistics SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions VisitorStatisticsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both VisitorStatisticsSDK(...) and VisitorStatisticsSDK.test(...) become
#      VisitorStatisticsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "visitorstatistics_sdk"
_SDK_CLASS = "VisitorStatisticsSDK"
