...
from visitorstatistics_sdk.utility import register

# Load features
from visitorstatistics_sdk.feature.base_feature import VisitorStatisticsBaseFeature
from visitorstatistics_sdk.features import _has_feature, _make_feature
...
class VisitorStatisticsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = VisitorStatisticsUtility()
    ...
    def get_utility(self):
        return VisitorStatisticsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("VisitorStatisticsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def VisitorArrival(self, data=None) -> "VisitorArrivalEntity":
        ...
        from visitorstatistics_sdk.entity.visitor_arrival_entity import VisitorArrivalEntity
