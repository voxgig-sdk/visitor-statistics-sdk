...
// VisitorStatistics SDK netsim feature
...
class VisitorStatisticsNetsimFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _simulate(VisitorStatisticsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(VisitorStatisticsContext $ctx, array $applied): void
    {
        $client = $this->client;
