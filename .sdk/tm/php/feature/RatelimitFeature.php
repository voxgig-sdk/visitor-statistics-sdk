...
// VisitorStatistics SDK ratelimit feature
...
class VisitorStatisticsRatelimitFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _acquire(VisitorStatisticsContext $ctx): void
    {
    ...
    private function _track(VisitorStatisticsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
