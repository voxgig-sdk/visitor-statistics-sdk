...
// VisitorStatistics SDK cache feature
...
class VisitorStatisticsCacheFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _through(VisitorStatisticsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
