...
// VisitorStatistics SDK rbac feature
...
class VisitorStatisticsRbacFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _required(VisitorStatisticsContext $ctx): ?string
    {
    ...
    private function _reject(VisitorStatisticsContext $ctx, string $required): void
    {
    ...
    private function _track(VisitorStatisticsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
