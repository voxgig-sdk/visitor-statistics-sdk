...
// VisitorStatistics SDK clienttrack feature
...
class VisitorStatisticsClienttrackFeature extends VisitorStatisticsBaseFeature
{
    ...
    public function PostConstruct(VisitorStatisticsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'VisitorStatistics-SDK';
