...
// VisitorStatistics SDK utility: graphql
//
...
class VisitorStatisticsGraphql
{
    ...
    // equivalent.
    public static function body(VisitorStatisticsContext $ctx): mixed
    {
    ...
    public static function errors(VisitorStatisticsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
