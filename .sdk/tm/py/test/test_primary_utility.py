...
from projectname_sdk import VisitorStatisticsSDK
...
from projectname_sdk.core.response import VisitorStatisticsResponse
from projectname_sdk.core.operation import VisitorStatisticsOperation
from projectname_sdk.core.error import VisitorStatisticsError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import VisitorStatisticsBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return VisitorStatisticsError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_done_basic(self):
        ...
        def subject(entry):
            ...
            except VisitorStatisticsError as e:
                return None, e
    ...
    def test_make_error_no_throw(self):
        ...
        ctx.result = VisitorStatisticsResult({
            "ok": False,
            "resdata": {"id": "safe01"},
        })
    ...
    def test_feature_init_basic(self):
        init_client = VisitorStatisticsSDK.test(None, None)
        ...
        class TestInitFeature(VisitorStatisticsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(VisitorStatisticsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_fetcher_live(self):
        ...
        live_client = VisitorStatisticsSDK({
    ...
    def test_fetcher_blocked_test_mode(self):
        ...
        blocked_client = VisitorStatisticsSDK({
            "base": "http://localhost:8080",
            "system": {
                "fetch": mock_fetch,
            },
    ...
    def test_make_fetch_def_basic(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = VisitorStatisticsSpec({
            "base": "http://localhost:8080",
            "prefix": "/api",
            "path": "items/{id}",
            "suffix": "",
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = VisitorStatisticsSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = VisitorStatisticsSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = VisitorStatisticsOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = VisitorStatisticsSDK.test(None, setup_opts)
