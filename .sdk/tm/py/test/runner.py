...
class VisitorStatisticsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = VisitorStatisticsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = VisitorStatisticsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = VisitorStatisticsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
