...
|---|---|---|
| `ts/` | @voxgig-sdk/visitor-statistics-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/visitor-statistics-sdk \
      --repository voxgig-sdk/visitor-statistics-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/visitor-statistics-sdk` shows it, and
`npm trust revoke @voxgig-sdk/visitor-statistics-sdk --id=<id>` removes it.
