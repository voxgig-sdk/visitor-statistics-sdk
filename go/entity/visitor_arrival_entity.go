...
type VisitorArrivalEntity struct {
	name    string
	client  *core.VisitorStatisticsSDK
...
func NewVisitorArrivalEntity(client *core.VisitorStatisticsSDK, entopts map[string]any) *VisitorArrivalEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VisitorArrivalEntity) GetName() string { return e.name }
...
func (e *VisitorArrivalEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VisitorArrivalEntity) Deleted() bool {
	return e.deleted
}


func (e *VisitorArrivalEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVisitorArrivalEntity(e.client, opts)
}

func (e *VisitorArrivalEntity) Data(args ...any) any {
...
func (e *VisitorArrivalEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an VisitorArrival; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VisitorArrivalEntity) DataTyped(data ...VisitorArrival) VisitorArrival {
	if len(data) > 0 {
		return typedFrom[VisitorArrival](e.Data(asMap(data[0])))
	}
	return typedFrom[VisitorArrival](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through VisitorArrival (all fields
// optional at the wire level).
func (e *VisitorArrivalEntity) MatchTyped(match ...VisitorArrival) VisitorArrival {
	if len(match) > 0 {
		return typedFrom[VisitorArrival](e.Match(asMap(match[0])))
	}
	return typedFrom[VisitorArrival](e.Match())
}
...
func (e *VisitorArrivalEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VisitorArrivalEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *VisitorArrivalEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VisitorArrivalListMatch and returns []VisitorArrival. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *VisitorArrivalEntity) ListTyped(reqmatch VisitorArrivalListMatch, ctrl map[string]any) ([]VisitorArrival, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[VisitorArrival](res), nil
}



func (e *VisitorArrivalEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *VisitorArrivalEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VisitorArrivalEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VisitorArrivalEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
