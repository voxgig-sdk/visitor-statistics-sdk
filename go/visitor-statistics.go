...
// instead of `sdk.NewVisitorStatisticsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *VisitorStatisticsSDK  { return NewVisitorStatisticsSDK(nil) }
func Test() *VisitorStatisticsSDK { return TestSDK(nil, nil) }
