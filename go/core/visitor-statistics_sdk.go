...
type VisitorStatisticsSDK struct {
	Mode     string
...
func (sdk *VisitorStatisticsSDK) OptionsMap() map[string]any {
...
func (sdk *VisitorStatisticsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *VisitorStatisticsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *VisitorStatisticsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VisitorStatisticsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *VisitorStatisticsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *VisitorStatisticsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("VisitorStatisticsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *VisitorStatisticsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *VisitorStatisticsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("VisitorStatisticsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *VisitorStatisticsSDK {
	...
	sdk := NewVisitorStatisticsSDK(sdkopts)
	sdk.Mode = "test"
