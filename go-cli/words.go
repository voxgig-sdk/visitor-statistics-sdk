...
func registerSDKWords(r *eng.Registry, client *sdk.VisitorStatisticsSDK) {
...
func runOp(client *sdk.VisitorStatisticsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
