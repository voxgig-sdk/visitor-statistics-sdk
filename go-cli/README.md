...
AQL-driven CLI and REPL for the VisitorStatistics SDK. Positional arguments are
...
```sh
go build -o visitor-statistics-cli ./...
```
...
./visitor-statistics-cli load 1 visitor_arrival
./visitor-statistics-cli load '{id:1}' visitor_arrival
