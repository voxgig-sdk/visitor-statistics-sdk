// Command VisitorStatistics-cli is a CLI + REPL for the VisitorStatistics SDK,
...
const prompt = "visitor-statistics"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "visitor_arrival"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      VISITOR_STATISTICS_APIKEY (api key), VISITOR_STATISTICS_BASE (base url override)")
