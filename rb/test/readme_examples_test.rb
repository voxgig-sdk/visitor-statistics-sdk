...
#      offline in seeded test mode (VisitorStatisticsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "VisitorStatistics_sdk.rb")
  SDK_CLASS = "VisitorStatisticsSDK"
  ...
  SDK_BASE = "VisitorStatistics_sdk"
