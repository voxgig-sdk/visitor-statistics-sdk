...
This API provides access to data regarding visitor arrivals in Hong Kong by country and region of residence.

Learn more about Visitor Statistics API at [data.gov.hk/en-data/dataset/hk-censtatd-tablechart-650-80001](https://data.gov.hk/en-data/dataset/hk-censtatd-tablechart-650-80001).
...
$visitorarrivals = $client->VisitorArrival()->list();
print_r(array_map(fn($item) => $item->data_get(), $visitorarrivals));
```
