...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/visitor-statistics` | `npm install @voxgig-sdk/visitor-statistics` |
| Python | `voxgig-sdk-visitor-statistics` | `pip install voxgig-sdk-visitor-statistics` |
| PHP | `voxgig-sdk/visitor-statistics` | `composer require voxgig-sdk/visitor-statistics` |
| Golang | `github.com/voxgig-sdk/visitor-statistics-sdk/go` | `go get github.com/voxgig-sdk/visitor-statistics-sdk/go` |
| Ruby | `voxgig-sdk-visitor-statistics` | `gem install voxgig-sdk-visitor-statistics` |
| Lua | `voxgig-sdk-visitor-statistics` | `luarocks install voxgig-sdk-visitor-statistics` |
