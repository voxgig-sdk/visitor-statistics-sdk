...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.VISITORSTATISTICS_TEST_LIVE ||
    'TRUE' === process.env.VISITORSTATISTICS_TEST_OVERRIDE
  ) {
  ...
  m.VISITORSTATISTICS_TEST_EXPLAIN = process.env.VISITORSTATISTICS_TEST_EXPLAIN || m.VISITORSTATISTICS_TEST_EXPLAIN
