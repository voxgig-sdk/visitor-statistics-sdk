...
(0, node_test_1.describe)('VisitorArrivalDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.VisitorStatisticsSDK({
    ...
    (0, node_test_1.test)('direct-list-visitor_arrival', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-visitor_arrival', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.VISITOR_STATISTICS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.VisitorStatisticsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['VISITOR_STATISTICS_TEST_VISITOR_ARRIVAL_ENTID'];
    ...
    const client = new __1.VisitorStatisticsSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=VisitorArrivalDirect.test.js.map