...
function envOverride(m) {
    if ('TRUE' === process.env.VISITOR_STATISTICS_TEST_LIVE ||
        'TRUE' === process.env.VISITOR_STATISTICS_TEST_OVERRIDE) {
    ...
    m.VISITOR_STATISTICS_TEST_EXPLAIN = process.env.VISITOR_STATISTICS_TEST_EXPLAIN || m.VISITOR_STATISTICS_TEST_EXPLAIN;
    return m;
}
