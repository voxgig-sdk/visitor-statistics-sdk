...
type Args struct {
	Entity string         `json:"entity" jsonschema:"visitor_arrival"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.VisitorStatisticsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "visitor-statistics_list",
		Description: "List records from VisitorStatistics. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "visitor-statistics_load",
		Description: "Load a single record from VisitorStatistics. " +
...
func runOp(client *sdk.VisitorStatisticsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.VisitorStatisticsSDK, name string) (sdk.VisitorStatisticsEntity, error) {
	switch strings.ToLower(name) {
	case "visitor_arrival":
		return client.VisitorArrival(nil), nil
