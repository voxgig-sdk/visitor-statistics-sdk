// Command VisitorStatistics-mcp is an MCP server exposing the VisitorStatistics
// SDK as MCP tools.
//
// Two tools are registered:
//
//	VisitorStatistics_list  — list records of an entity
//	VisitorStatistics_load  — load a single record of an entity
//
