...
local VisitorArrivalEntity = {}
VisitorArrivalEntity.__index = VisitorArrivalEntity


function VisitorArrivalEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, VisitorArrivalEntity)
  self._name = "visitor_arrival"
  self._client = client
...
function VisitorArrivalEntity:get_name()
  return self._name
end


function VisitorArrivalEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return VisitorArrivalEntity.new(self._client, opts)
end
...
function VisitorArrivalEntity:mark_deleted()
  self._deleted = true
end


function VisitorArrivalEntity:deleted()
  return true == self._deleted
end


function VisitorArrivalEntity:data_set(args)
  if args ~= nil then
...
function VisitorArrivalEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function VisitorArrivalEntity:match_set(args)
  if args ~= nil then
...
function VisitorArrivalEntity:match_get()
...
function VisitorArrivalEntity:stream(action, args, callopts)
...
function VisitorArrivalEntity:_run_op(ctx, post_done)
  local utility = self._utility
