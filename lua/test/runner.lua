...
function runner.env_override(m)
  local live = runner.getenv("VISITORSTATISTICS_TEST_LIVE")
  local override = runner.getenv("VISITORSTATISTICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("VISITORSTATISTICS_TEST_EXPLAIN")
