...
function runner.env_override(m)
  local live = runner.getenv("VISITOR_STATISTICS_TEST_LIVE")
  local override = runner.getenv("VISITOR_STATISTICS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("VISITOR_STATISTICS_TEST_EXPLAIN")
