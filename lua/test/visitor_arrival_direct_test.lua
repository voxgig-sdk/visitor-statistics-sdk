...
describe("VisitorArrivalDirect", function()
  it("should direct-list-visitor_arrival", function()
    local setup = visitor_arrival_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-visitor_arrival", setup.live and "live" or "unit")
...
function visitor_arrival_direct_setup(mockres)
