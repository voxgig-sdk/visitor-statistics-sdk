...
Results: Successful response with visitor arrival statistics.
...
| --- | --- | --- | --- |
| VisitorArrival | `list` | `GET /visitor-arrivals` | See reference |

## Connect to the API

- Hong Kong Open Data API Server: `https://data.gov.hk/api`
...
- `visitor-statistics_list`: List records for an entity. Supported entities: `visitor_arrival`.
- `visitor-statistics_load`: Load one record for an entity. No active entity supports this operation.
