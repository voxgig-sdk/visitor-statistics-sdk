...
// VisitorStatistics SDK streaming feature
...
class VisitorStatisticsStreamingFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _iterate(VisitorStatisticsResult $result): \Generator
    {
    ...
    private function _streamable(VisitorStatisticsContext $ctx): bool
    {
