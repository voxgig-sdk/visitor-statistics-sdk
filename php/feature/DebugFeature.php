...
// VisitorStatistics SDK debug feature
...
class VisitorStatisticsDebugFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _finish(VisitorStatisticsContext $ctx, bool $ok): void
    {
