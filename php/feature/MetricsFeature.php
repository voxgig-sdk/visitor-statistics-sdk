...
// VisitorStatistics SDK metrics feature
...
class VisitorStatisticsMetricsFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _record(VisitorStatisticsContext $ctx, bool $ok): void
    {
