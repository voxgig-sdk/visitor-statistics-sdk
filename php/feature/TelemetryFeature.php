...
// VisitorStatistics SDK telemetry feature
...
class VisitorStatisticsTelemetryFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _close(VisitorStatisticsContext $ctx, bool $ok): void
    {
