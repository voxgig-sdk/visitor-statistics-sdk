...
// VisitorStatistics SDK audit feature
...
class VisitorStatisticsAuditFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _emit(VisitorStatisticsContext $ctx, string $outcome): void
    {
