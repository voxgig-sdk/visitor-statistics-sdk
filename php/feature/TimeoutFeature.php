...
// VisitorStatistics SDK timeout feature
...
class VisitorStatisticsTimeoutFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _with_timeout(VisitorStatisticsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(VisitorStatisticsContext $_ctx, float $ms): void
    {
        $client = $this->client;
