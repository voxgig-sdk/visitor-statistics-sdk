...
// VisitorStatistics SDK idempotency feature
...
class VisitorStatisticsIdempotencyFeature extends VisitorStatisticsBaseFeature
{
    ...
    private function _mutating(VisitorStatisticsContext $ctx): bool
    {
