...
// VisitorStatistics SDK proxy feature
...
class VisitorStatisticsProxyFeature extends VisitorStatisticsBaseFeature
{
    ...
    public function init(VisitorStatisticsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (VisitorStatisticsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
