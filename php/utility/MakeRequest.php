...
// VisitorStatistics SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class VisitorStatisticsMakeRequest
{
    public static function call(VisitorStatisticsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new VisitorStatisticsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new VisitorStatisticsResponse($fetched);
        } else {
