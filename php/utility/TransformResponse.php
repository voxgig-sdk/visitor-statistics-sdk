...
// VisitorStatistics SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class VisitorStatisticsTransformResponse
{
    public static function call(VisitorStatisticsContext $ctx): mixed
    {
        ...
        $transform = VisitorStatisticsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
