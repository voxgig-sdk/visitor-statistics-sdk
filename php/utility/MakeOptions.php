...
// VisitorStatistics SDK utility: make_options

class VisitorStatisticsMakeOptions
{
    ...
    public static function call(VisitorStatisticsContext $ctx): array
    {
        ...
        //
        // `VisitorStatisticsSchema::optspec()` is built from the model:
        ...
        $optspec = VisitorStatisticsSchema::optspec();
