...
// VisitorStatistics SDK utility: fetcher

class VisitorStatisticsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; VisitorStatisticsSDK/1.0)';
    ...
    public static function call(VisitorStatisticsContext $ctx, string $fullurl, array $fetchdef): array
    {
