...
// VisitorStatistics SDK utility type

class VisitorStatisticsUtility
{
    ...
    public static function copy(VisitorStatisticsUtility $src): VisitorStatisticsUtility
    {
        $u = new VisitorStatisticsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
