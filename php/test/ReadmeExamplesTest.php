...
// VisitorStatistics SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (VisitorStatisticsSDK::test)
...
{
    private const SDK_CLASS = 'VisitorStatisticsSDK';
    ...
    private const SDK_BASE = 'visitorstatistics_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../visitorstatistics_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
