...
// VisitorStatistics SDK pipeline test
//
...
{
    private static function utility(): VisitorStatisticsUtility
    {
        return new VisitorStatisticsUtility();
    }
    ...
    private static function ctx(array $over = []): VisitorStatisticsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new VisitorStatisticsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new VisitorStatisticsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof VisitorStatisticsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new VisitorStatisticsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = VisitorStatisticsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new VisitorStatisticsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = VisitorStatisticsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new VisitorStatisticsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = VisitorStatisticsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VisitorStatisticsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = VisitorStatisticsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new VisitorStatisticsResponse([]),
            'result' => new VisitorStatisticsResult([]),
        ]);
        [, $err] = VisitorStatisticsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec([]),
            'response' => null,
            'result' => new VisitorStatisticsResult([]),
        ]);
        [, $err] = VisitorStatisticsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec(['step' => 's']),
            'response' => new VisitorStatisticsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new VisitorStatisticsResult([]),
        ]);
        [, $err] = VisitorStatisticsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec(['step' => 's']),
            'response' => new VisitorStatisticsResponse(self::resp(200, ['v' => 1])),
            'result' => new VisitorStatisticsResult([]),
        ]);
        [, $err] = VisitorStatisticsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec(['step' => 's']),
            'response' => new VisitorStatisticsResponse(self::resp(200, ['v' => 2])),
            'result' => new VisitorStatisticsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        VisitorStatisticsMakeResponse::call($ctx);
    ...
    {
        $preset = new VisitorStatisticsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec([]),
            'response' => new VisitorStatisticsResponse([]),
            'result' => new VisitorStatisticsResult([]),
        ...
        [$got, $err] = VisitorStatisticsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new VisitorStatisticsResult([])]);
        [, $err] = VisitorStatisticsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new VisitorStatisticsSpec([]), 'result' => null]);
        [, $err] = VisitorStatisticsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VisitorStatisticsSpec(['step' => 's']),
            'result' => new VisitorStatisticsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new VisitorStatisticsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VisitorStatisticsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new VisitorStatisticsSpec(['step' => 's']),
            'result' => new VisitorStatisticsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new VisitorStatisticsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = VisitorStatisticsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new VisitorStatisticsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new VisitorStatisticsSpec([]),
            'result' => new VisitorStatisticsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = VisitorStatisticsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VisitorStatisticsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new VisitorStatisticsError('boom', 'boom');
        $utility->fetcher = function (VisitorStatisticsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VisitorStatisticsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = VisitorStatisticsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (VisitorStatisticsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = VisitorStatisticsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(VisitorStatisticsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        VisitorStatisticsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (VisitorStatisticsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new VisitorStatisticsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = VisitorStatisticsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new VisitorStatisticsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new VisitorStatisticsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = VisitorStatisticsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = VisitorStatisticsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = VisitorStatisticsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new VisitorStatisticsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, VisitorStatisticsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new VisitorStatisticsResult(['ok' => false])]);
        $this->expectException(VisitorStatisticsError::class);
        VisitorStatisticsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new VisitorStatisticsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', VisitorStatisticsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        VisitorStatisticsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new VisitorStatisticsBaseFeature();
        $b = new VisitorStatisticsBaseFeature();
        VisitorStatisticsFeatureAdd::call($ctx, $a);
        VisitorStatisticsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): VisitorStatisticsBaseFeature
    {
        $f = new VisitorStatisticsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        VisitorStatisticsFeatureAdd::call($ctx, self::named_feature('a'));
        VisitorStatisticsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        VisitorStatisticsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        VisitorStatisticsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        VisitorStatisticsFeatureAdd::call($ctx, $replace);
        ...
        VisitorStatisticsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): VisitorStatisticsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new VisitorStatisticsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = VisitorStatisticsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        VisitorStatisticsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new VisitorStatisticsResponse(['headers' => null]),
            'result' => new VisitorStatisticsResult([]),
        ]);
        VisitorStatisticsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        VisitorStatisticsResultBody::call($ctx);
