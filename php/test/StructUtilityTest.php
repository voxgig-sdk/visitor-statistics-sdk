...
// VisitorStatistics SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = VisitorStatisticsOmni::makeStructRunner(
    ...
    {
        return VisitorStatisticsOmni::objmodel(VisitorStatisticsOmni::argval($val));
    }

    /** A single-case fixture value on the comparison side. */
    private static function outval($val)
    {
        return VisitorStatisticsOmni::unmark($val);
    }

    /** A result normalised to the comparison model. */
    private static function resval($val)
    {
        return VisitorStatisticsOmni::structfix($val, Struct::undef());
    }
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(VisitorStatisticsOmni::structfix($now, Struct::undef()))
                        !== json_encode(VisitorStatisticsOmni::structfix($val, Struct::undef()))) {
